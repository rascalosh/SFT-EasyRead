...
-- sedangkan frontend defaultnya font ramah disleksia AKTIF dengan spasi 0.12
-- dan focus ruler aktif.
--
...
alter table public.reading_preferences alter column letter_spacing set default 0.12;
alter table public.reading_preferences alter column focus_ruler_enabled set default true;
