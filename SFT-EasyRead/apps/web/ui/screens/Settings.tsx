...
import { IconSettings, IconBook, IconSpeaker, IconTextSize } from "../components/icons"
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <div className="divide-y divide-line">
            <Toggle on={dyslexicFont} onToggle={() => setDyslexicFont((v) => !v)} label="Font Ramah Disleksia" desc="Gunakan font khusus dengan bentuk huruf yang lebih mudah dibedakan." />
            <Toggle on={ruler} onToggle={() => setRuler((v) => !v)} label="Penggaris Fokus Digital" desc="Sorot baris yang sedang dibaca agar tidak mudah lompat." />
          </div>
        ...
        <Card>
          ...
          <div className="divide-y divide-line">
            <Toggle on={autoTTS} onToggle={() => setAutoTTS((v) => !v)} label="Putar Text-to-Speech Otomatis" desc="Bacakan teks secara otomatis saat membuka bacaan baru." />
          </div>
          <div className="mt-4 border-t border-line pt-4">
