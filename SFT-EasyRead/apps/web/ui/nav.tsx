...
export type NavItem = { id: ScreenId; label: string; icon: ReactNode }

export const bottomNavItems: NavItem[] = [
  { id: "progress", label: "Progress & Achievement", icon: <IconChart /> },
  { id: "assessment", label: "Penilaian Membaca", icon: <IconMic /> },
